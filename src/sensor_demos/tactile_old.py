...
@ti.data_oriented
class OldRigidContactSensor(Sensor):
    """
...
@ti.data_oriented
class OldRigidContactForceSensor(OldRigidContactSensor):
    """
...
@ti.data_oriented
class OldRigidContactForceGridSensor(OldRigidContactForceSensor):
    """
